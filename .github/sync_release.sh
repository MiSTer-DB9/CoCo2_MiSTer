...
UPSTREAM_REPO="https://github.com/MiSTer-devel/CoCo2_MiSTer.git"
CORE_NAME=(CoCo2)
...
UPSTREAM_CORE_NAME=(CoCo2)
MAIN_BRANCH="master"
UPSTREAM_BRANCH="master"
COMPILATION_INPUT=(CoCo2.qpf)
COMPILATION_OUTPUT=(output_files/CoCo2.rbf)
